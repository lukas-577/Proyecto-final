...
<body>
				...
				<div class="col-lg-12">
					<div class="bo-links">
						<a href="./index.html"><i class="fa fa-home"></i> Home</a> <a
							href="./portfolio.html">Detalle Album</a> <span>Color of
							natural</span>
					</div>
				</div>
			</div>
	...
	<section class="portfolio-hero-section set-bg"
		data-setbg="img/portfolio/details/details-hero.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="ph-text">
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
						...
						maecenas accumsan lacus vel facilisis. Nemo enim ipsam voluptatem
						spernatur.</p>
				</div>
				<div class="col-lg-4">
					<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
						odit aut fugit. Vivamus at nibh tincidunt, bibendum ligula id.
						Nemo enim ipsam voluptatem quiatotam rem aperiam, eaque ipsa quae
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<a href="img/portfolio/details/details-hero.jpg" class="btn btn-primary btn-user btn-block" download="imagen">
					comprar </a>
			</div>
			<div class="col-sm"></div>
		</div>
	</div>
	<!--     fin boton para comprar -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="fs-widget">
						...
						<div class="fw-instagram">
							<img src="img/instagram/insta-1.jpg" alt=""> <img
								src="img/instagram/insta-2.jpg" alt=""> <img
								src="img/instagram/insta-3.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="fs-widget">
						<h5>Subscribe</h5>
						<p>Imolor amet consectetur adipiscing elit, sed do eiusmod
							tempor incididunt.</p>
